...
public class AddEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (_mode == MainActivity.MODE_INSERT) {
            ...
            etInputPass.setText(ListData.getListPass());
        ...
        if(inputName.equals("")) {
            ...
            if(_mode == MainActivity.MODE_INSERT) {
                if (!inputName.equals("")) {
                    ...
                    extras.putString("pass", inputPass);
                ...
                DataAccess.insert(db, inputName, inputPass, inputGenre, inputMemo);
            }
            else {
                Bundle extras = new Bundle();
                extras.putString("name", inputName);
                ...
                FragmentManager manager = getSupportFragmentManager();
                dialog.show(manager, "AddDialogFragment");
                DataAccess.update(db, _idNo, inputName, inputPass, inputGenre, inputMemo);
            }
//            finish();
        }
    }
    ...
    public void onClickSamplePass(View view) {
        ...
        try {
            ...
            if (isNumeric) {
                ...
                if (intKeta <= 12) {
                    EditText et = (EditText) findViewById(R.id.etSamplePass);
                    int length = intNum;
//                    String symbol= "-/^&amp*!%=+";
